 ...
 * @since  [产品/模块版本]
 */
public class CommunityMyEditFragment extends BaseFragment implements UICallBack, OnHeaderRefreshListener
{
    private View view;
    ...
    private void initData()
    {
        ...
        groupType = Constants.MY_MANAGED_COMMUNITY;
        ...
        listView.setOnItemClickListener(new OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3)
            {
                ...
                intent.putExtra("circleId", groups.get(position).getId());
                intent.putExtra("circleName", groups.get(position).getName());
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                getActivity().startActivity(intent);
            }
        });
        adapter = new CommunityCircleAdapter(groups, getActivity(), Constants.HE_MANAGED_COMMUNITY);
     ...
     * @see [类、类#方法、类#成员]
     */
    private void loadTitle(TextView view, String exist)
    {

...
public class CommunityDynamicAdapter extends BaseAdapter
{
    ...
    public CommunityDynamicAdapter(List<Topic> data, Context context, UICallBack callBack)
    {
        super();
        this.data = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = LayoutInflater.from(this.context).inflate(R.layout.community_dynamic_item, null);
//            viewHolder.headImage = (ImageView)convertView.findViewById(R.id.head);
//            viewHolder.vip = (ImageView)convertView.findViewById(R.id.icon_vip);
            viewHolder.comeText = (TextView)convertView.findViewById(R.id.come);
            viewHolder.name = (TextView)convertView.findViewById(R.id.name);
            viewHolder.time = (TextView)convertView.findViewById(R.id.time);
            viewHolder.come = (TextView)convertView.findViewById(R.id.come_from);
            viewHolder.content = (TextView)convertView.findViewById(R.id.content);
//            viewHolder.photo = (LinearLayout)convertView.findViewById(R.id.photo);
            viewHolder.imgLayout = (RelativeLayout)convertView.findViewById(R.id.imgLayout);
            viewHolder.imgFirst = (ImageView)convertView.findViewById(R.id.imgFirst);
            
            viewHolder.vote = (LinearLayout)convertView.findViewById(R.id.yes_or_no);
            viewHolder.agree = (LinearLayout)convertView.findViewById(R.id.agree);
            viewHolder.disagree = (LinearLayout)convertView.findViewById(R.id.disagree);
            viewHolder.yesNum = (TextView)convertView.findViewById(R.id.yes_num);
            viewHolder.noNum = (TextView)convertView.findViewById(R.id.no_num);
            ...
            viewHolder.chatLayout = (LinearLayout)convertView.findViewById(R.id.chat_layout);
            viewHolder.chat = (TextView)convertView.findViewById(R.id.community_chat);
            viewHolder.moreLayout = (LinearLayout)convertView.findViewById(R.id.more_layout);
            
//            viewHolder.likeLayout = (LinearLayout)convertView.findViewById(R.id.community_like_layout);
//            viewHolder.chatLayout = (LinearLayout)convertView.findViewById(R.id.community_chat_layout);
//            viewHolder.moreLayout = (LinearLayout)convertView.findViewById(R.id.more_layout);
//            viewHolder.like = (TextView)convertView.findViewById(R.id.community_like);
//            viewHolder.chat = (TextView)convertView.findViewById(R.id.community_chat);
//            viewHolder.praise = (ImageView)convertView.findViewById(R.id.praise);
            ...
            viewHolder.upToTop = (ImageView)convertView.findViewById(R.id.up_to_top);
...
//        }
        ...
        viewHolder.come.setText(data.get(position).getName());
        //未赞
...
//            }
         ...
         * 添加按钮点击事件
         */
        viewHolder.like.setText(data.get(position).getPraiseNum());
        viewHolder.chat.setText(data.get(position).getComment());
        //响应头像按钮点击事件
...
//        });
        ...
        viewHolder.chatLayout.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                intent.putExtra("id", data.get(position).getArticleId());
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                context.startActivity(intent);
            }
        });

...
public class Constants
{
     ...
     * 个人中心添加房屋
     */
    public static final String ADD_HOUSE_BROADCAST = "com.ymdq.thy.add.house";
    
    /**
     * 首页的选择小区
     */
    public static final String SELECT_NEW_COMMUNITY = "com.ymdq.thy.select.new.community";
    
    /**
     * 个人中心删除房屋
     */
    public static final String DELETE_HOUSE_BROADCAST = "com.ymdq.thy.delete_house";
    
    /**
     * 公告分享后数量加1
     */
    public static final String ADVERTISE_SUCCESS_BROADCAST = "com.ymdq.thy.advertise.success";
    
    /**
     * 话题分享后数量加1
     */
    public static final String TOPIC_SUCCESS_BROADCAST = "com.ymdq.thy.topic.success";
    
    /**
     * 点赞数量+1
     */
    public static final String COMMUNITY_PRAISE_COUNT = "com.ymdq.thy.community_praise";
    
    /**
     * 评论数量+1
     */
    public static final String COMMUNITY_COMMENT_COUNT = "com.ymdq.thy.community_comment";
    
    /**
     * 表扬数量+1
     */
    public static final String COMMUNITY_AGREE_COUNT = "com.ymdq.thy.community_agree";
    
    /**
     * 反对数量+1
     */
    public static final String COMMUNITY_DISAGREE_COUNT = "com.ymdq.thy.community_disagree";
    
    /**
     * 物业未读消息数量
     */
    public static final String COMMUNITY_MESSAGE_NUMBER_BROADCAST = "com.ymdq.thy.login.community_message_number";

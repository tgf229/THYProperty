...
public class JRApplication extends Application
{
     ...
     * app实例
     */
    public static JRApplication jrApplication = null;
...
//                .discCache(new UnlimitedDiscCache(new File(FileSystemManager.getCacheImgFilePath(context))))
        ...
        String picEmpty)
    {
        ...
        //通过图片名调用图片ID
        int fail = context.getResources().getIdentifier(picFail, "drawable", "com.ymdq.thy");
        int loading = context.getResources().getIdentifier(picLoading, "drawable", "com.ymdq.thy");
        int empty = context.getResources().getIdentifier(picEmpty, "drawable", "com.ymdq.thy");
        options =
